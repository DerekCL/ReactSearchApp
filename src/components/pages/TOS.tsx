    ...
    <div className="TOS">
        ...
        <ol type="a">
            <li>
                ...
                materials (information or software) on Derek Lewandowski's web
                ...
                <ol type="i">
                    ...
                    <li>
                        ...
                        contained on Derek Lewandowski's web site;
                    </li>
                    <li>
            ...
            <li>
                ...
                these restrictions and may be terminated by Derek Lewandowski at
        ...
        <ol type="a">
            <li>
                ...
                is". Derek Lewandowski makes no warranties, expressed or
                implied, and hereby disclaims and negates all other warranties,
                including without limitation, implied warranties or conditions
                of merchantability, fitness for a particular purpose, or
                non-infringement of intellectual property or other violation of
                rights. Further, Derek Lewandowski does not warrant or make any
